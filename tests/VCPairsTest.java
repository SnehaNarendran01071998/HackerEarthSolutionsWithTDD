...
class VCPairsTest {
    ...
    void shouldReturnZeroWhenThereAreNoVowelsInTheString() {
        ...
        String input = "t";
        Assertions.assertEquals(0, vcPairs.countVcPairs(input));
    }
    ...
    void shouldReturnOneWhenThereIsAConsonantFollowedByAVowel() {
        VCPairs vcPairs = new VCPairs();
        String input = "to";
        Assertions.assertEquals(1, vcPairs.countVcPairs(input));
    }
    @Test
    void shouldReturnTwoAsCountWhenThereAreTwoVCPairs() {
        VCPairs vcPairs = new VCPairs();
        String input = "toto";
        Assertions.assertEquals(2, vcPairs.countVcPairs(input));
    }
    @Test
